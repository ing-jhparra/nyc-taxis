...
def etl_fuel():
    ...
    #filtered_df.to_csv('Datasets_limpios/vehículo_fuel.csv', index=False)
    return filtered_df    
...
def etl_electrico(df_electrico):
    ...
    #df_electrico.to_csv('Datasets_limpios/vehículo_electrico.csv', index=False)
    return df_electrico  
...
def etl_hibrido(df_hibrido):
    ...
    #df_hibrido.to_csv('Datasets_limpios/vehículo_hibrido.csv', index=False)
    return df_hibrido