...
def EtlTaxisTrip(carpeta, archivo_base, archivo_consolidado, sample_size=100000):
    ...
    df_consolidado.to_parquet('Datasets_limpios/yellow_tripdata_clean.parquet', index=False)
...
archivo_consolidado = './Datasets/yellow_tripdata_consolidado.parquet'  # ruta y nombre del Archivo consolidado
